...
public class Book implements Serializable {
    ...
    private String chapterUrl;//书目Url  若是本地书籍时则为当前书籍的绝对地址
    ...
    private boolean isLocal = false;//是否为本地书籍

    @Generated(hash = 1530836687)
    public Book(String id, String name, String chapterUrl, String imgUrl,
            ...
            int chapterTotalNum, int lastReadPosition, boolean isLocal) {
        this.id = id;
        this.name = name;
